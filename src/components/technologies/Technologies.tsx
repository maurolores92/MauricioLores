...
const Technologies = () => {
    ...
    >
        <Box sx={{paddingTop:'4rem'}}>
            ...
            <Typography color='white' fontWeight='400' sx={{ maxWidth: '800px', margin: '2rem auto', textAlign:'jutify' }}>Sumérgete en el mundo de las tecnologías modernas y eficientes que empleo para desarrollar sitios web y aplicaciones profesionales de alta calidad. A continuación, te presento algunas de las herramientas que utilizo para llevar a cabo proyectos innovadores y exitosos.</Typography>
            </Box>
